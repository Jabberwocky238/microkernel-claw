...
export abstract class CapabilityRegistryServiceProvider extends ServiceProvider {
  ...
  public abstract unregister(capabilityId: string, pluginName?: string): void | Promise<void>;

  public abstract get(capabilityId: string): CapabilityProvider[] | Promise<CapabilityProvider[]>;
